...
<p align=center><i>Increase transparency with the help of Open Data within the education sector/js</i></p>
...
#### Seed data
To seed a local test environment use the `seed.js` for your local mongodb instance.
